...
echo "
<div class='row'><div class='col-lg-6 col-lg-offset-3'><h1>Admin Configuration</h1>
<form class='form-horizontal' role='form' name='adminConfiguration' action='".$_SERVER['PHP_SELF']."' method='post'>
  <div class='form-group'>
    <label for='settings' class='col-lg-2 control-label'>Website name</label>
    <div class='col-lg-10'>
     <input type='text' class='form-control'  name='settings[".$settings['website_name']['id']."]' value='".$websiteName."' />
    </div>
  </div>
    <div class='form-group'>
    <label for='websiteurl' class='col-lg-2 control-label'>Website Url</label>
    <div class='col-lg-10'>
     <input type='text' class='form-control' name='settings[".$settings['website_url']['id']."]' value='".$websiteUrl."' />
    </div>
  </div>
    <div class='form-group'>
    <label for='settings' class='col-lg-2 control-label'>E-mail</label>
    <div class='col-lg-10'>
     <input type='text' class='form-control' name='settings[".$settings['email']['id']."]' value='".$emailAddress."' />
    </div>
  </div>
    <div class='form-group'>
    <label for='settings' class='col-lg-2 control-label'>Resend</label>
    <div class='col-lg-10'>
    ...
    <div class='form-group'>
    <label for='settings' class='col-lg-2 control-label'>Languages</label>
    <div class='col-lg-10'>
...
echo "
    ...
    <div class='form-group'>
    <label for='settings' class='col-lg-2 control-label'>Email Activation</label>
    <div class='col-lg-10'>
...
echo "
    ...
    <div class='form-group'>
    <label for='settings' class='col-lg-2 control-label'>Template</label>
    <div class='col-lg-10'>
