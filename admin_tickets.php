...
echo "<h4><a href='#' class='add-catalogue'><span class='glyphicon glyphicon-plus-sign'></span> Add New Ticket</a></h4>";
echo "<table class='table table-striped table-hover add-table col-lg-6'>
		...
		<tr>
			...
			<td><input type='number' id='qty' placeholder='Please fill the input with the Quantity of tickets' class='form-control'/></td>
			<td><select id='act' class='form-control'><option value=''>Select an option</option><option value='1'>Open</option><option value='0'>Close</option></select></td>
...
foreach ($tickets as $v1) {
	...
	<tr id='".$v1['id']."'>
		...
		<td class='price'>".$v1['price']."</td>
		<td class='qty'>".$v1['qty']."</td>
