...
<form class='form-horizontal' role='form' name='adminPage' action='".$_SERVER['PHP_SELF']."?id=".$pageId."' method='post'>
<h4>ID: ".$pageDetails['id']." - Page Name = ".$pageDetails['page']."</h4>
  ...
  <div class='form-group'>
    <label for='settings' class='col-lg-2 control-label'>Remove Access</label>
    <div class='col-lg-10'>
...
echo"
    ...
    <label for='settings' class='col-lg-2 control-label'>Add Access</label>
    <div class='col-lg-10'>";
...
echo"
 ...
 <div class='form-group'>
    <div class='col-lg-offset-2 col-lg-10'>
      <input type='submit' class='btn btn-default' value='Update' class='submit' /> 
    </div>
  </div>
</form>
</div>
